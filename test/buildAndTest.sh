...
g++ -Wall -std=c++14 -I../include -c Test.cpp 

## Compilo el Binario
g++ -I./include Inventory.o Client.o WspMessenger.o IgMessenger.o FbMessenger.o Item.o Product.o Rent.o Test.o -o Test.bin
